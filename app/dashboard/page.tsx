          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-muted-foreground">
                Welcome to your personal dashboard. Here&apos;s what&apos;s happening with your account.
              </p>
            </div>
            <Button asChild>
              <Link href="/profile">
              ...
              <div className="flex items-center justify-between mb-4">
                <div className="space-y-1">
                  ...
                  <p className="text-sm text-muted-foreground">
                    {getProfileCompletion()}% complete - Add more details to enhance your experience
                  </p>
                </div>
                    ...
                    return (
                      <div key={index} className="flex items-center space-x-3">
                        <div className={`p-2 rounded-full ${
                          ...
                          activity.status === 'pending' ? 'bg-yellow-100 text-yellow-600 dark:bg-yellow-900 dark:text-yellow-400' :
